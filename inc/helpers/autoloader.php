...
namespace DecoupledTabs\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( DECOUPLED_TABS_PATH ), $directory, $file_name );
...
spl_autoload_register( '\DecoupledTabs\Inc\Helpers\autoloader' );
